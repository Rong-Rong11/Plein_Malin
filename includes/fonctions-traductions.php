...
function traductions_recherche(): array
{
	return [
		...
		"La position utilisée est estimée à partir de l'adresse IP et sert seulement à chercher les stations proches." => "The position used is estimated from the IP address and is only used to search for nearby stations.",
...
function traductions_resultats(): array
{
	return [
		...
		"Ville estimée par IP" => "City estimated by IP",
		"Région estimée par IP" => "Region estimated by IP",
		"Source de localisation" => "Location source",
		"Position estimée indisponible pour le moment." => "Estimated position is currently unavailable.",
		...
		"Recherche autour de la position estimée à partir de l'adresse IP." => "Search around the position estimated from the IP address.",
...
function traductions_pages_info(): array
{
	return [
		...
		"Géolocalisation : position estimée à partir de l'adresse IP pour rechercher les stations proches." => "Geolocation: position estimated from the IP address to search for nearby stations.",
		...
		"Le bouton Autour de moi utilise une position estimée à partir de l'adresse IP pour chercher les stations proches." => "The Near me button uses a position estimated from the IP address to search for nearby stations.",
		...
		"La position estimée à partir de l'adresse IP peut pointer vers une zone proche plutôt que vers l'adresse exacte." => "The position estimated from the IP address may point to a nearby area instead of the exact address.",
		...
		"La recherche autour de moi utilise une position estimée à partir de l'adresse IP pour chercher les stations proches." => "The near me search uses a position estimated from the IP address to search for nearby stations.",
